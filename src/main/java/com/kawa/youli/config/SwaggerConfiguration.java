...
public class SwaggerConfiguration {
    // controller路径
    private final String basePackage = "com.kawa.youli.controller";
    ...
    private ApiInfo apiInfo() {
        // 接口联系人信息
        Contact contact = new Contact("KAWA", "", "kawalyq@163.com");
        // 接口信息
        return new ApiInfo("YouLi", "YouLi", "v1",
                "http://localhost:8080", contact, "YouLi 1.0",
                "", new ArrayList<>());
    }
}
